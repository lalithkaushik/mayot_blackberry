...
var BlitzMap = new function(){
        ...
        this.init = function() {
            ...
            if( isEditable ){
                    ...
                    drwManager = new google.maps.drawing.DrawingManager({ 
                        ...
                        markerOptions: { editable: false, draggable:false },              // markers created are editable by default
                        circleOptions: { editable: false },              // circles created are editable by default
                        rectangleOptions: { editable: false },   // rectangles created are editable by default
                        polygonOptions: { editable: false },             // polygons created are editable by default
                        polylineOptions: { editable: false },            // polylines created are editable by default
                    });
            }
        ...
        this.updateOverlay = function(){
                ...
                infWindow.relatedOverlay.content = '';
        ...
        function mapToObject(){
          ...
          this.toJSONString = function(){
                  ...
                  if( mapStorageId ){
						  ...
						  $('#info_date').html('Coordinates generated, please click "Add this area as exclusion zone"');
                  }
